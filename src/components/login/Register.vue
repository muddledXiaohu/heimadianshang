  ...
  <div class="contanior">
    <div class="main">
      ...
      >
        ...
        <!-- <el-form-item type="password" prop="phone">
          <el-input v-model="registerForm.password" placeholder="密码" class="input-left55"></el-input>
        </el-form-item>-->
      ...
      <div class="icon">
        <p>其他方式登录</p>
        <span class="iconfont left20 icon-icon-test5"></span>
        <span class="iconfont center-icon-color icon-alipay"></span>
        <span class="iconfont right-color icon-icon-test3"></span>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    async loginRegister () {
      ...
      // console.log(res)
      // const flag = res.data.filter(item => item.username === this.registerForm.phone)
      // if (flag.length === 0) {
      //   this.$message.error('手机号没有注册，去注册')
