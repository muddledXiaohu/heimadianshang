...
// 调用的tabList标签mock
Mock.mock('http://api.cms.liulongbin.top/tabdatalist', 'get', function (options) {
  console.log(options)
  return {
    data: [
      {
        id: '0',
        title: '新品',
        swiper_Img: 'https://ss1.bdstatic.com/70cFvXSh_Q1YnxGkpoWK1HF6hhy/it/u=2705628763,3753647254&fm=26&gp=0.jpg',
        context: '手机',
        img_List: [
          {
            little_img: 'https://www.mi.com/buy/seckill',
            little_title: '10X 4G'
          },
          {
            little_img: 'https://www.mi.com/buy/seckill',
    ...
    meta: { status: 200, message: '获取数据成功！' }
  }
})

// Select的Mock
Mock.mock('http://api.cms.liulongbin.top/selectList', 'get', function (options) {
  console.log(options)
  return {
    data: [
      {
...
Mock.mock('http://api.cms.liulongbin.top/shopList', 'get', function (options) {
  console.log(options)

  return {
    data: [
      {
        thum_img: '//cdn.cnbj1.fds.api.mi-img.com/mi-mall/f1273fa0f531e5c586d25f04d95d434d.png',
        title_name: 'Redmi 10X 4G',
        shop_des: '5000mAh长循环大电量 / 6.53"超大护眼屏幕 / G25八核处理器 / 大音量扬声器 / 1300万 AI相机 / 人脸解锁 / 最高支持512GB存储扩展',
        id: '1',
        shop_price: '999',
        shop_assess: '13088条评价 99.8%满意'
      },
      {
        thum_img: '//cdn.cnbj1.fds.api.mi-img.com/mi-mall/ea78a429738f84c43ff0d0859acdfd39.png',
        title_name: 'Redmi 10X 5G',
        shop_des: '5000mAh长循环大电量 / 6.53"超大护眼屏幕 / G25八核处理器 / 大音量扬声器 / 1300万 AI相机 / 人脸解锁 / 最高支持512GB存储扩展',
        id: '2',
        shop_price: '999',
        shop_assess: '13088条评价 99.8%满意'
      ...
      {
        thum_img: '//cdn.cnbj1.fds.api.mi-img.com/mi-mall/e33cb1ebca8a91a3c1031b5bae47e1da.png',
        title_name: 'Redmi 10X 6G',
        shop_des: '5000mAh长循环大电量 / 6.53"超大护眼屏幕 / G25八核处理器 / 大音量扬声器 / 1300万 AI相机 / 人脸解锁 / 最高支持512GB存储扩展',
        id: '3',
        shop_price: '999',
        shop_assess: '13088条评价 99.8%满意'
      ...
      {
        thum_img: '//cdn.cnbj1.fds.api.mi-img.com/mi-mall/2a47c566e14b2da1a6cc0780060a59d0.png',
        title_name: 'Redmi 10X 7G',
        shop_des: '5000mAh长循环大电量 / 6.53"超大护眼屏幕 / G25八核处理器 / 大音量扬声器 / 1300万 AI相机 / 人脸解锁 / 最高支持512GB存储扩展',
        id: '4',
        shop_price: '999',
        shop_assess: '13088条评价 99.8%满意'
...
// 地图
Mock.mock('http://api.cms.liulongbin.top/userinfo', 'get', function () {
  // 方式1-直接返回数据
  return {
    code: 0,
    data: {
      store_type_list: [{
        ...
        store_list: [{
          type_name: 'mihome',
          store_no: 'MI0281',
          store_name: '小米之家成都万象城店',
          shop_time: '10:00-22:00',
          distance: '',
          position: {
            lat: '30.656023',
            lng: '104.121644',
            icon: 'http://i8.mifile.cn/v1/a1/87fbaa8d-73a4-247a-acea-dea9fed47099.png'
          },
          address: '四川省成都市成华区双庆路 8 号成都万象城301号商铺',
          mihome_id: '603',
          tel: '028-83118554',
          support_service: [
            '团购',
          ...
          detail_img_url: 'http://i8.mifile.cn/v1/a1/be49fdc4-ab2c-96e1-a9c0-beb6e2d3768a!1080x660.jpg',
          detail_img360_url: '',
          transport: '',
          mi_icon: 'http://i8.mifile.cn/v1/a1/161705c3-99a5-8345-ab6c-84f0422fb501.png',
          main_product: ''
        },
        {
          type_name: 'mihome',
          store_no: 'MI51143',
          store_name: '小米之家成都大源世豪广场店',
          shop_time: '10：00-22：00',
          distance: '',
          position: {
            lat: '30.556161',
          ...
          address: '四川省成都市武侯区剑南大道中段998号世豪广场1楼C116号',
          mihome_id: '7260',
          tel: '028-67139606',
          support_service: [
            '团购',
          ...
          detail_img_url: 'https://i6.mifile.cn//b2c-men/oms/a/84/5ba4c6fa7f35f.png',
          detail_img360_url: '',
          transport: '',
          mi_icon: 'http://i8.mifile.cn/v1/a1/161705c3-99a5-8345-ab6c-84f0422fb501.png',
          main_product: ''
        },
        {
          type_name: 'mihome',
          store_no: 'MI51153',
          store_name: '小米之家成都远洋太古里店',
          shop_time: '周日到周四：10:00-22:00,周五，周六：10:00-22:30',
          distance: '',
          position: {
            lat: '30.658402',
            lng: '104.088991',
          ...
          address: '四川省成都市锦江区中纱帽街8号(成都远洋太古里店)地下一层M008号商铺',
          mihome_id: '7650',
          tel: '028-84511788',
          support_service: [
            '团购',
          ...
          detail_img_url: 'https://i6.mifile.cn//b2c-men/oms/9/71/5baf6145e6729.png',
          detail_img360_url: '',
          transport: '',
          mi_icon: 'http://i8.mifile.cn/v1/a1/161705c3-99a5-8345-ab6c-84f0422fb501.png',
          main_product: ''
        },
        {
          ...
          address: '成都市金牛区中交大路183号凯德广场1期1楼M103号商铺',
          mihome_id: '7655',
          tel: '028-64642506 ',
          support_service: [
            '团购',
          ...
          detail_img_url: 'https://i6.mifile.cn//b2c-men/oms/2/46/5c3d96f762c5f.jpg',
          detail_img360_url: '',
          transport: '',
          mi_icon: 'http://i8.mifile.cn/v1/a1/161705c3-99a5-8345-ab6c-84f0422fb501.png',
          main_product: ''
        },
        {
          ...
          address: '四川省成都市锦江区红星路三段1号IFS国际金融中心6楼602',
          mihome_id: '11193',
          tel: '028-86728718',
          support_service: [
            '团购',
          ...
          detail_img_url: 'https://i6.mifile.cn//b2c-men/oms/c/75/5c739823c9013.jpg',
          detail_img360_url: '',
          transport: '',
          mi_icon: 'http://i8.mifile.cn/v1/a1/161705c3-99a5-8345-ab6c-84f0422fb501.png',
          main_product: ''
        },
        {
          type_name: 'mihome',
          store_no: 'JM00065',
          store_name: '小米成都双流海滨城广场专卖店',
          shop_time: '周日至周四 10:00-22:00 周五-周六及节假日10:00-22:30',
          distance: '',
          position: {
            lat: '30.609801',
            lng: '103.915152',
          ...
          address: '四川省成都市双流区蛟龙工业港双流园区海滨城一层A102号',
          mihome_id: '1866',
          tel: '028-81488888',
          support_service: [
            '团购',
          ...
          detail_img_url: 'http://i8.mifile.cn/v1/a1/3311a43a-8e46-348c-ce20-1330dc4b168d!1080x660.jpg',
          detail_img360_url: '',
          transport: '',
          mi_icon: 'http://i8.mifile.cn/v1/a1/161705c3-99a5-8345-ab6c-84f0422fb501.png',
          main_product: ''
        },
        {
          type_name: 'mihome',
          store_no: 'JM00090',
          store_name: '小米都江堰百伦数码广场专卖店',
          shop_time: '9:00-21:00',
          distance: '',
          position: {
            lat: '30.999810',
            lng: '103.633041',
          ...
          address: '四川省都江堰市都江堰大道65号苏宁易购1F右侧',
          mihome_id: '1882',
          tel: '028-87225566',
          support_service: [
            '团购',
          ...
          detail_img_url: 'https://i6.mifile.cn//b2c-men/oms/3/12/5ca1abc54f6e9.jpg',
          detail_img360_url: '',
          transport: '',
          mi_icon: 'http://i8.mifile.cn/v1/a1/161705c3-99a5-8345-ab6c-84f0422fb501.png',
          main_product: ''
        },
        {
          ...
          address: '四川省成都市双流区西航港街道锦华路二段172号北京华联空港购物中心一层F105',
          mihome_id: '5777',
          tel: '028-62753852',
          support_service: [
            '团购',
          ...
          detail_img_url: 'https://i6.mifile.cn//b2c-men/oms/0/6/5aff87ccef8fd.jpg',
          detail_img360_url: '',
          transport: '',
          mi_icon: 'http://i8.mifile.cn/v1/a1/161705c3-99a5-8345-ab6c-84f0422fb501.png',
          main_product: ''
        },
        {
          ...
          address: '四川省成都市一环路北三段一号金牛万达一楼1026A.1026B',
          mihome_id: '6487',
          tel: '028—62608888',
          support_service: [
            '团购',
          ...
          detail_img_url: 'https://i6.mifile.cn//b2c-men/oms/7/39/5b487b9cd84e3.png',
          detail_img360_url: '',
          transport: '',
          mi_icon: 'http://i8.mifile.cn/v1/a1/161705c3-99a5-8345-ab6c-84f0422fb501.png',
          main_product: ''
        },
        {
          ...
          address: ' 四川省成都市锦江区锦华路一段 68 号成都锦华路万达广场室内步行街 1F 层 167A 号',
          mihome_id: '7280',
          tel: '028-62677888',
          support_service: [
            '团购',
          ...
          detail_img_url: 'https://i6.mifile.cn//b2c-men/oms/1/98/5b6abc66818d0.jpg',
          detail_img360_url: '',
          transport: '',
          mi_icon: 'http://i8.mifile.cn/v1/a1/161705c3-99a5-8345-ab6c-84f0422fb501.png',
          main_product: ''
        },
        {
          type_name: 'mihome',
          store_no: 'JM11190',
          store_name: '小米成都赛格广场专卖店',
          shop_time: '10:00-20:00',
          distance: '',
          position: {
            lat: '30.671294',
            lng: '104.083607',
          ...
          address: '四川省成都市青羊区太升南路赛格广场222号一号门1楼',
          mihome_id: '7302',
          tel: '028-85954457',
          support_service: [
            '团购',
          ...
          detail_img_url: 'https://i6.mifile.cn//b2c-men/oms/8/87/5b7b8318d9684.jpg',
          detail_img360_url: '',
          transport: '',
          mi_icon: 'http://i8.mifile.cn/v1/a1/161705c3-99a5-8345-ab6c-84f0422fb501.png',
          main_product: ''
        },
        {
          type_name: 'mihome',
          store_no: 'JM11234',
          store_name: '小米成都龙泉驿万达广场专卖店',
          shop_time: '10:00-22:00（周五周六10:00-22:30）',
          distance: '',
          position: {
            lat: '30.569942',
            lng: '104.272802',
          ...
          address: '四川省成都市龙泉驿区永安路万达广场 1 层 1082 号商铺',
          mihome_id: '8699',
          tel: '028-63957250',
          support_service: [
            '团购',
          ...
          detail_img_url: 'https://i6.mifile.cn//b2c-men/oms/d/17/5bd08ae1f1a1b.jpg',
          detail_img360_url: '',
          transport: '',
          mi_icon: 'http://i8.mifile.cn/v1/a1/161705c3-99a5-8345-ab6c-84f0422fb501.png',
          main_product: ''
        },
        {
          ...
          address: '四川省成都市成华区建设北路三段 2 号 A 馆龙湖三千集-1F-20 号',
          mihome_id: '11285',
          tel: '028-61305888',
          support_service: [
            '团购',
          ...
          detail_img_url: 'https://i6.mifile.cn//b2c-men/oms/9/92/5be4239667a66.jpg',
          detail_img360_url: '',
          transport: '',
          mi_icon: 'http://i8.mifile.cn/v1/a1/161705c3-99a5-8345-ab6c-84f0422fb501.png',
          main_product: ''
        },
        {
          ...
          address: '四川省成都市锦江区大业路 6 号 1 栋一层 1020 号',
          mihome_id: '11711',
          tel: '028-67831888',
          support_service: [
            '团购',
          ...
          detail_img_url: 'https://i6.mifile.cn//b2c-men/oms/a/72/5bf2832e61628.jpg',
          detail_img360_url: '',
          transport: '',
          mi_icon: 'http://i8.mifile.cn/v1/a1/161705c3-99a5-8345-ab6c-84f0422fb501.png',
          main_product: ''
        },
        {
          ...
          address: '四川省成都市武侯区人民南路四段 3 号成都来福士广场01-32 号商铺',
          mihome_id: '12687',
          tel: '028-60195292',
          support_service: [
            '团购',
          ...
          detail_img_url: 'https://i6.mifile.cn//b2c-men/oms/c/93/5c2f3a3ade24c.jpg',
          detail_img360_url: '',
          transport: '',
          mi_icon: 'http://i8.mifile.cn/v1/a1/161705c3-99a5-8345-ab6c-84f0422fb501.png',
          main_product: ''
        },
        {
          type_name: 'mihome',
          store_no: 'JM11308',
          store_name: '小米成都大悦城专卖店',
          shop_time: '周一至周四：10:00-22:00，周五至周日：10:00-22:30',
          distance: '',
          position: {
            lat: '30.631834',
            lng: '104.018507',
          ...
          address: ' 四川省成都市武侯区大悦路 518 号成都大悦城附一层 LG- 071',
          mihome_id: '13808',
          tel: '028-66329978',
          support_service: [
            '团购',
          ...
          detail_img_url: 'https://i6.mifile.cn//b2c-men/oms/1/11/5c41353837f44.jpg',
          detail_img360_url: '',
          transport: '',
          mi_icon: 'http://i8.mifile.cn/v1/a1/161705c3-99a5-8345-ab6c-84f0422fb501.png',
          main_product: ''
        },
        {
          type_name: 'mihome',
          store_no: 'JM11309',
          store_name: '小米成都绿地伊藤洋华堂专卖店',
          shop_time: '9:00-22:30',
          distance: '',
          position: {
            lat: '30.611267',
            lng: '104.161744',
          ...
          address: '四川省成都市锦江区喜树街35号伊藤洋华堂绿地店1F-WF001 ',
          mihome_id: '13962',
          tel: '028-81703139',
          support_service: [
            '团购',
          ...
          detail_img_url: 'https://i6.mifile.cn//b2c-men/oms/e/86/5c48442410018.jpg',
          detail_img360_url: '',
          transport: '',
          mi_icon: 'http://i8.mifile.cn/v1/a1/161705c3-99a5-8345-ab6c-84f0422fb501.png',
          main_product: ''
        },
        {
          ...
          address: '四川省成都市郫都区万达广场内购物中心室内步行街一层1070号商铺',
          mihome_id: '24463',
          tel: '028-65496888',
          support_service: [
            '团购',
          ...
          detail_img_url: 'https://i6.mifile.cn//b2c-men/oms/6/74/5cb072dac7fde.jpg',
          detail_img360_url: '',
          transport: '',
          mi_icon: 'http://i8.mifile.cn/v1/a1/161705c3-99a5-8345-ab6c-84f0422fb501.png',
          main_product: ''
        },
        {
          ...
          address: '成都市郫都区犀浦镇泰山北街1号1栋1单元1楼120号附2号',
          mihome_id: '27059',
          tel: '028—68492888',
          support_service: [
            '团购',
          ...
          detail_img_url: 'https://i6.mifile.cn//b2c-men/oms/3/27/5e04715a9d433.jpg',
          detail_img360_url: '',
          transport: '',
          mi_icon: 'http://i8.mifile.cn/v1/a1/161705c3-99a5-8345-ab6c-84f0422fb501.png',
          main_product: ''
        },
        {
          type_name: 'offline',
          store_no: 'SC-356',
          store_name: '小米武侯区吾悦广场授权体验店',
          shop_time: '',
          distance: '',
          position: {
            lat: '30.625420',
            lng: '103.990020',
            icon: 'http://i8.mifile.cn/v1/a1/bb241dbd-d585-0156-fd53-0b6caabde489.png'
          },
          address: '武侯区武侯大道武兴二路1号',
          mihome_id: '6486',
          tel: '15882488058',
          support_service: [],
          detail_img_url: 'http://i8.mifile.cn/v1/a1/7aa5839c-6997-c906-9d2a-e57575c5fe7c!1080x660.jpg',
          detail_img360_url: '',
          transport: '',
          mi_icon: '',
          main_product: '部分手机、生态链产品'
        },
        {
          type_name: 'offline',
          store_no: 'SC-121',
          store_name: '小米简阳市时代广场授权体验店',
          shop_time: '',
          distance: '',
          position: {
            lat: '30.412444',
          ...
          address: '四川省成都市简阳市河东新区雄州大道389号旭海时代广场A1-1-5号',
          mihome_id: '2798',
          tel: '028-27758966',
          support_service: [],
          detail_img_url: 'http://i8.mifile.cn/v1/a1/7aa5839c-6997-c906-9d2a-e57575c5fe7c!1080x660.jpg',
        ...
        },
        {
          ...
          address: '四川省成都市双流区星空路999号双流万达广场1F',
          mihome_id: '6480',
          tel: '18123377601',
          support_service: [],
          detail_img_url: 'http://i8.mifile.cn/v1/a1/7aa5839c-6997-c906-9d2a-e57575c5fe7c!1080x660.jpg',
        ...
        },
        {
          ...
          address: '四川省成都市邛崃市临邛镇市府街30号1楼小米授权体验店',
          mihome_id: '2833',
          tel: '028-88792525',
          support_service: [],
          detail_img_url: 'http://i8.mifile.cn/v1/a1/7aa5839c-6997-c906-9d2a-e57575c5fe7c!1080x660.jpg',
        ...
        },
        {
          ...
          address: '成都市温江区光华大道三段1588号成都珠江广场1F',
          mihome_id: '6393',
          tel: '18328380682',
          support_service: [],
          detail_img_url: 'http://i8.mifile.cn/v1/a1/7aa5839c-6997-c906-9d2a-e57575c5fe7c!1080x660.jpg',
        ...
        },
        {
          ...
          address: '四川省成都市龙泉驿区吾悦广场一号门外下沉负一楼',
          mihome_id: '8170',
          tel: '19934398389',
          support_service: [],
          detail_img_url: 'http://i8.mifile.cn/v1/a1/7aa5839c-6997-c906-9d2a-e57575c5fe7c!1080x660.jpg',
        ...
        },
        {
          ...
          address: '成都市武侯区聚龙路999号室内步行街【1F】层【1026】号商铺',
          mihome_id: '8171',
          tel: '028-63921333',
          support_service: [],
          detail_img_url: 'http://i8.mifile.cn/v1/a1/7aa5839c-6997-c906-9d2a-e57575c5fe7c!1080x660.jpg',
        ...
        },
        {
          ...
          address: '四川省成都市青羊区光华大道一段光华北三路55号鹏瑞利广场2号门星巴克旁',
          mihome_id: '8172',
          tel: '18617019598',
          support_service: [],
          detail_img_url: 'http://i8.mifile.cn/v1/a1/7aa5839c-6997-c906-9d2a-e57575c5fe7c!1080x660.jpg',
        ...
        },
        {
          ...
          address: '成都市金牛区五块石路1号北城天街 北馆 1F-018',
          mihome_id: '8239',
          tel: '18380209613',
          support_service: [],
          detail_img_url: 'http://i8.mifile.cn/v1/a1/7aa5839c-6997-c906-9d2a-e57575c5fe7c!1080x660.jpg',
        ...
        },
        {
          ...
          address: '四川省成都市新都区新都镇新泰东路71号115-116号小米授权店',
          mihome_id: '8279',
          tel: '13550153925',
          support_service: [],
          detail_img_url: 'http://i8.mifile.cn/v1/a1/7aa5839c-6997-c906-9d2a-e57575c5fe7c!1080x660.jpg',
        ...
        },
        {
          ...
          address: '四川省成都市成华区府青路二段2号财富又一城一层114A-115号',
          mihome_id: '8271',
          tel: '028-61290888',
          support_service: [],
          detail_img_url: 'http://i8.mifile.cn/v1/a1/7aa5839c-6997-c906-9d2a-e57575c5fe7c!1080x660.jpg',
        ...
        },
        {
          ...
          address: '四川省成都市成华区东华二路38号附101号 铁建广场内L1',
          mihome_id: '8015',
          tel: '028-62613666',
          support_service: [],
          detail_img_url: 'http://i8.mifile.cn/v1/a1/7aa5839c-6997-c906-9d2a-e57575c5fe7c!1080x660.jpg',
        ...
        },
        {
          ...
          address: '四川省成都市金堂县赵镇万泰街6号金堂万达广场三号门一楼1022号',
          mihome_id: '7738',
          tel: '028-64325500',
          support_service: [],
          detail_img_url: 'http://i8.mifile.cn/v1/a1/7aa5839c-6997-c906-9d2a-e57575c5fe7c!1080x660.jpg',
        ...
        },
        {
          ...
          address: '成都市新都区大丰街道方元路51号 （汇融广场）一楼16号 ',
          mihome_id: '7554',
          tel: '18380229766',
          support_service: [],
          detail_img_url: 'http://i8.mifile.cn/v1/a1/7aa5839c-6997-c906-9d2a-e57575c5fe7c!1080x660.jpg',
      ...
      },
      {
        ...
        },
        {
          ...
          address: '四川省成都市武侯区二环路西段置信路1号置信逸都城',
          mihome_id: '185',
          tel: '15388196665',
          support_service: [],
          detail_img_url: '',
        ...
        },
        {
          ...
          address: '四川省成都市青羊市中心太升南路222号童子街29号赛格广场1层',
          mihome_id: '100',
          tel: '',
          support_service: [],
          detail_img_url: '',
        ...
        },
        {
          ...
          transport: '',
          mi_icon: '',
          main_product: '部分手机、生态链��品'
        },
        {
          type_name: 'offline',
          store_no: 'SC-037',
          store_name: '成都利群蜀汉路电信营业厅',
          shop_time: '',
          distance: '',
          position: {
            lat: '30.700280',
        ...
        },
        {
          ...
          address: '四川成都市成华区建设路店',
          mihome_id: '5459',
          tel: '',
          support_service: [],
          detail_img_url: 'http://i8.mifile.cn/v1/a1/e2ad2a93-a5fa-e574-d32c-c3b0ef480701!1080x660.jpg',
          detail_img360_url: '',
          transport: '',
          mi_icon: '',
          main_product: '部分手机、生态链产品'
        },
        {
          ...
          address: '成都市双流区华阳正西街43号缤纷广场2-3层',
          mihome_id: '7802',
          tel: '',
          support_service: [],
          detail_img_url: 'http://i8.mifile.cn/v1/a1/e2ad2a93-a5fa-e574-d32c-c3b0ef480701!1080x660.jpg',
      ...
      },
      {
        ...
        store_list: [{
          ...
          address: '成都市-环路南二段17号A世界电脑城7楼708号',
          mihome_id: 'XM1670',
          tel: '',
          support_service: [],
          detail_img_url: '',
        ...
        },
        {
          ...
          address: '成都市青羊区太升南路222号赛格广场-楼中国电信旁',
          mihome_id: 'WDCN01231',
          tel: '',
          support_service: [],
          detail_img_url: '',
        ...
        },
        {
          ...
          address: '成华区双林路22号仁禾商务楼三楼308号( 万年场十字路口苏宁易购背后）',
          mihome_id: 'XM165015',
          tel: '',
          support_service: [],
          detail_img_url: '',
        ...
        },
        {
          ...
          address: '新都区西街民生巷17号(成都医学院第-附属医院对面巷内）',
          mihome_id: 'XM165006',
          tel: '',
          support_service: [],
          detail_img_url: '',
        ...
        },
        {
          ...
          address: '郫都区郫县东大街462号（时代花城2期398公交车站）',
          mihome_id: 'XM165004',
          tel: '',
          support_service: [],
          detail_img_url: '',
...
Mock.mock('http://api.cms.liulongbin.top/getCity', 'get', function () {
  return {
    status: '200',
    data: {
      S: [
...
Mock.mock('http://api.cms.liulongbin.top/login', 'get', function () {
  return {
    data: {
      username: '15182014252',
      password: '123456'
    },
    meta: {
      status: 200
...
Mock.mock('http://api.cms.liulongbin.top/123xh', 'get', function (options) {
  console.log(options)
  return {
    xhData: [
      { text: '全部商品', value: 0 },
    ...
    commodity: [
      {
        ...
        title: '华为（HUAWEI）荣耀6Plus',
        details: '华为（HUAWEI）荣耀6Plus 16G双4G版华为（HUAWEI）荣耀6Plus 16G双4G版',
        state: '已签收',
        market_price: 1,
        sell_price: 2195
      },
      {
        src: 'http://demo.dtcms.net/upload/201504/20/thumb_201504200318534459.jpg',
        title: '飞利浦DVP3690 全高清',
        details: '飞利浦（PHILIPS）DVP3690 全高清DVD影碟机播放器飞利浦（PHILIPS）DVP3690 全高清DVD影碟机播放器',
        state: '已取消',
        market_price: 1,
        sell_price: 400
      },
      {
        ...
        title: '苹果Apple iPhone 6手机（联通三网版）',
        details: '苹果Apple iPhone 6 Plus 16G 4G手机（联通三网版）苹果Apple iPhone 6 Plus 16G 4G手机（联通三网版）',
        state: '已取消',
        market_price: 1,
        sell_price: 5595
      },
      {
        src: 'http://demo.dtcms.net/upload/201504/20/thumb_201504200253026047.jpg',
        title: '惠普(HP)商用彩色喷墨一体机',
        details: '惠普(HP) Officejet Pro 8610商用彩色喷墨一体机惠普(HP) Officejet Pro 8610商用彩色喷墨一体机',
        state: '已签收',
        market_price: 1,
        sell_price: 399
      },
      {
        ...
        title: '小米（Mi）小米 16G双网通版',
        details: '小米（Mi）小米Note 16G双网通版小米（Mi）小米Note 16G双网通版小米（Mi）小米Note 16G双网通版',
        state: '已取消',
        market_price: 1,
        sell_price: 1998
      }
